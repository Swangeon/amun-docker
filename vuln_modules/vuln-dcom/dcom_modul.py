...
class vuln:
	...
	def incoming(self, message, bytes, ip, vuLogger, random_reply, ownIP):
		try:
			...
			if self.stage == "DCOM_STAGE1" and (bytes == 72 or bytes == 1024 or bytes == 116 or bytes == 205 or bytes == 204 or bytes==408 or bytes==168):
				if dcom_shellcodes.dcom_request_stage1_1==message or dcom_shellcodes.dcom_request_stage1_2==message or dcom_shellcodes.dcom_request_stage1_3==message or dcom_shellcodes.dcom_request_stage1_4==message or dcom_shellcodes.dcom_request_stage1_5==message:
					...
					return resultSet
				elif dcom_shellcodes.dcom_request_stage1_7==message:
					resultSet['result'] = True
					resultSet['accept'] = True
					self.reply[2] = "\x0C"
					self.reply[20] = "\x05"
